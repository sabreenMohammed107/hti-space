                                ...
                                <select required class="form-select form-select-solid dynamic"
                                    ...
                                    @foreach ($professors as $professor)
                                        <option value="{{ $professor->id }}"
                                            @foreach ($profSubjects as $sublist) {{ $sublist->professor_id == $professor->id ? 'selected' : '' }} @endforeach >{{ $professor->user->name ?? '' }}
                                        </option>
                                    @endforeach
                                </select>
                        </div>
                            ...
                            <select required class="form-select form-select-solid" name="subjects[]"
                                ...
                                @foreach ($subjects as $subject)
                                    <option value="{{ $subject->id }}"
                                        @foreach ($prof->subjects as $sublist) {{ $sublist->id == $subject->id ? 'selected' : '' }} @endforeach  >{{ $subject->name }}
                                    </option>
                                @endforeach
