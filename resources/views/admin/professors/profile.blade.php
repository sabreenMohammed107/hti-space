    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Professor</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
       ...
       <a href="{{route('admin.home')}}" class="text-muted text-hover-primary">Home</a>
                    ...
                    <li class="breadcrumb-item text-muted">Professor</li>
...
@section('content')
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="container-xxl">
            ...
            action="{{ route('saveProfProfile') }}" method="post" enctype="multipart/form-data">
            @csrf
<input type="hidden" name="professor_id" value="{{$row->id}}" >
     ...
     <div class="card card-flush py-4">
        ...
        <div class="card-body text-center pt-0">
            ...
            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                style="background-image: url('{{ asset('uploads/professors') }}/{{ $row->image }}')">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="position" value="{{$row->position}}"
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        {{-- <a href="{{ route('professors.index') }}" id="kt_ecommerce_add_product_cancel"
